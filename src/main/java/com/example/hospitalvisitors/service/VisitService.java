...
public class VisitService {
    ...
    public VisitResponse writeNewRecord(String uid, VisitRequest visitRequest) { // specific user id is conveyed
        ...
        /* 위에서 사용자 아이디로 찾았듯이, 각각 병명과 병원 명으로 Disease 와 Hospital 객체를 찾는다. */


        visit.setDisease(); // 찾은 Disease 를 visit 테이블에 추가한다.
        visit.setHospital() // 찾은 Hospital 를 visit 테이블에 추가한다.
